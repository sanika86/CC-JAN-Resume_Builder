...
public class Award_CV extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Enter Your Award Achivement and it's field discription.");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/award.png"))); // NOI18N
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        try{
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/cv_resume_builder", "root", "");

            stmt =  conn.createStatement();

            stmt.executeUpdate("INSERT INTO `award`(`UserId`, `aYear`, `Achivement`, `aOrganization`) VALUES ('"+userid+"','"+Integer.parseInt(jTextField8.getText())+"','"+jTextArea1.getText()+"','"+jTextField5.getText()+"');");
        }
        catch(Exception e)
        {
...
//            stmt.executeUpdate("INSERT INTO `award`(`UserId`, `aYear`, `Achivement`, `aOrganization`) VALUES ('"+userid+"','"+Integer.parseInt(jTextField8.getText())+"','"+jTextArea1.getText()+"','"+jTextField5.getText()+"');");
        ...
        try{
            Class.forName("com.mysql.jdbc.Driver");
            con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/cv_resume_builder", "root", "");
...
//                stmt.executeUpdate("INSERT INTO `award`(`UserId`, `aYear`, `Achivement`, `aOrganization`) VALUES ('"+userid+"','"+Integer.parseInt(jTextField8.getText())+"','"+jTextArea1.getText()+"','"+jTextField5.getText()+"');");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Award_CV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
